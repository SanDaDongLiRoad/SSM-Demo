    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="panel panel-default">
                    <div class="panel-body">
                        <form id="batch-add-user-form" name="batch-add-user-form" role="form" method="post" enctype="multipart/form-data">
            ...
            <div class="modal-footer">
                ...
                <button type="button" id = "save-user-btn" class="btn btn-primary">确认上传</button>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal -->
</div>
